...
case $1 in
    'up' )
        ...
        #firefox http://0.0.0.0:8078/#/ http://0.0.0.0:8073/nifi/ http://0.0.0.0:8075/ &
        
        docker-compose scale worker_1=3
